...
class ExposedTemplateView extends TemplateView implements ViewInterface {
	...
	public function getParsedTemplate() {
		...
		$compiled = $this->templateCompiler->has($templateIdentifier);
		return TRUE === $compiled ? $this->templateCompiler->get($templateIdentifier) : $this->templateParser->parse($source);
	}
